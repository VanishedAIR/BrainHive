  ...
  return (
    <div className="flex-1 pt-4 px-4">
      <div className="flex flex-col max-w-[1400px] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-4 border-2 border-border rounded-xl mb-8 md:mb-16 h-[60vh] lg:h-[75vh">
          <div className="lg:w-[60%] p-4 lg:border-r border-border overflow-y-auto h-[60vh] lg:h-[75vh]">
